...
//	Tag tag11 = tagRepo.save(new Tag("Acceptable Pop"));
	...
	Artist artist6 = artistRepo.save(new Artist ("Beyoncé", "https://specials-images.forbesimg.com/imageserve/59f4e6c24bbe6f37dda1445b/416x416.jpg?background=000000&cropX1=81&cropX2=1997&cropY1=133&cropY2=2049", "Will never age", "Houston, TX",  "5"));
	Artist artist7 = artistRepo.save(new Artist ("Idles", "https://www.loudandquiet.com/interview/idles-the-bristol-punk-band-for-the-age-of-social-collapse-and-kanye-west/", "21", "Seattle", "4"));
	Artist artist8 = artistRepo.save(new Artist ("Beyoncé/JayZ", "https://media.vanityfair.com/photos/572114bbe1a62e181e91a62b/master/w_768,c_limit/beyonce-jay-z-lemonade.jpg", "40", "Houston", "4"));
