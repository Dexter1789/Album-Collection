...
//	Album album = albumRepo.save(new Album("", "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/No_image_available.svg/1024px-No_image_available.svg.png", , artist, tag, tag));
	...
	Album album7 = albumRepo.save(new Album("Joy as an Act of Resistance", "https://upload.wikimedia.org/wikipedia/en/e/e4/Idles-Joy_as_an_Act_of_Resistance.jpg",7, artist7, tag10, tag3 ));
	Album album8 = albumRepo.save(new Album("Every Thing Is Love", "https://static.stereogum.com/uploads/2018/06/Beyonce-and-Jay-Z-Everything-Is-Love-1529336950-640x640.jpg", 8, artist8, tag1));
	Album album9 = albumRepo.save(new Album("Snail Mail", "https://f4.bcbits.com/img/a0559333599_10.jpg", 9, artist9, tag3 ));
	Album album10 = albumRepo.save(new Album("Blueprint", "https://media.pitchfork.com/photos/5ab160c41e037771e6b2fb68/1:1/w_320/Alice%20Bag%20Blueprint.jpg", 10, artist10, tag2 ));
	Album album11 = albumRepo.save(new Album("Magus", "https://f4.bcbits.com/img/0013738366_10.jpg", 11, artist11, tag1));
	Album album12 = albumRepo.save(new Album("Snowy Egret, The Other Side of Air", "https://images-na.ssl-images-amazon.com/images/I/91ewoLBzJLL._SX355_.jpg", 12, artist12, tag2));
	Album album13 = albumRepo.save(new Album("Future Me Hates Me", "https://img.discogs.com/4TEI9bPcZrpwutDW28b_Nf9Oj_c=/fit-in/600x594/filters:strip_icc():format(jpeg):mode_rgb():quality(90)/discogs-images/R-12368548-1533844458-4834.jpeg.jpg", 13, artist13, tag1));
	Album album14 = albumRepo.save(new Album("FM", "https://static.stereogum.com/uploads/2018/11/Vince-Staples-FM-1541448359-640x640.jpg", 14, artist14, tag9, tag10));
